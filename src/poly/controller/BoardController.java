...
public class BoardController {
	...
	//댓글작성
		@RequestMapping(value = "board/CommentRegProc")
		public String CommentRegProc(HttpSession session, HttpServletRequest request, HttpServletResponse response,
				ModelMap model) throws Exception {
			log.info(this.getClass().getName() + "############# CommentRegProc 실행 ################");
			...
			try {
				...
				if (res > 0) {
					model.addAttribute("url", "/board/boardList.do?seq=" + seq);
					model.addAttribute("msg", "등록되었습니다.");
				} else {
					model.addAttribute("url", "/board/boardList.do?seq=" + seq);
					model.addAttribute("msg", "등록에 실패했습니다.");
		...
		public String CommentList(HttpSession session, HttpServletRequest request, HttpServletResponse response,
				ModelMap model) throws Exception {
			log.info(this.getClass().getName() + "############# CommentList 실행 ################");
