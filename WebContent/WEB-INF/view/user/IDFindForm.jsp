					...
					<div class="col-md-6" style="margin-left: 270px;">
						<header data-brackets-id="1466" class="header">
							<h3 data-brackets-id="1467" class="text-center">
								<span data-brackets-id="1468" class="text--semi-bold">ID</span> <span
									data-brackets-id="1469" class="text--light">Find</span>
							</h3>
						</header>


						<form class="login-form" name="idForm" id="login"
							action="/user/findingId.do" onsubmit="return findId(this)">
							<input type="text" class="input" placeholder="name"
								name="user_name" required /> <input type="email" class="input"
								placeholder="email" name="email" required="email" /> <input
								type="submit" value="아이디 찾기" class="button1" />
