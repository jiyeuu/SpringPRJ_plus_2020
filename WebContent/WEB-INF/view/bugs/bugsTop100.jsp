         ...
         <div class="col-md-6">
          <header data-brackets-id="1466" class="header">
	         <h3 data-brackets-id="1467" class="text-center">
	         	<span data-brackets-id="1468" class="text--semi-bold">Music</span> 
	         	<span data-brackets-id="1469" class="text--light">Chart</span>
					...
					<div style="width: 800px; margin: 0 auto;">
						<div>
							...
							<%=rList.get(a).getRank()%>
							<span style="color: #007ee5; margin-left: 10px"> 
